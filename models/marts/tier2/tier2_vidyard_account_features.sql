SELECT
    ...
    CASE WHEN vyorgs.organizationid IN (SELECT organizationid FROM {{ ref('stg_vidyard_active_features') }} WHERE featureid = 173) THEN true ELSE false end as SEOenabled
FROM
